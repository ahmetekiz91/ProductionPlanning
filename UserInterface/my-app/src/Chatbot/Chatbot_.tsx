...
const Chatbot: React.FC = () => {
  ...
  const getConnection = () => {
    WebSocketInstance.shouldReconnect=true;
  ...
  const handleResetChat = () => {
    WebSocketInstance.disconnect();
    WebSocketInstance.shouldReconnect=false;
    setChatHistory([]);
    setMessage("");
    setInputType("input");
  };
        ...
        <div className="chatbox">
          <div className="row">
            ...
            <div className="col-4 mt-4 text-center">
              <BootstrapSwitchButton checked={true} width={120} style="text-size:12px;" onlabel='Open' offlabel='Close' onstyle="outline-success" offstyle="outline-danger"
